...
from gucompaper.Analysis_SGU import ChangeofMind, ChangeofMindTheta, ChangeofMindRemoteTheta
...
from gucompaper.changeOfMind_figures.supp_thetacycle_concentration import theta_amplitude_to_cycle
