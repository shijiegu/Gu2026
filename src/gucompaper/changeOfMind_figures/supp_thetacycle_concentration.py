...
from gucompaper.Analysis_SGU import (EpochPos,TrialChoice,Decode,
...
from gucompaper.changeOfMind_figures.supp_decode import return_diff_file
...
from gucompaper.changeOfMind_helper import nodes
