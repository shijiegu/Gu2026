...
from gucompaper.load import load_epoch_data, linear_segment2str
from gucompaper.ripple_detection import removeArtifactTime, load_position, loadRippleLFP_OneChannelPerElectrode
