...
from gucompaper.Analysis_SGU import TrialChoice,RippleTimes,EpochPos,get_linearization_map
...
from gucompaper.curation_manual import get_session_duration
from gucompaper.fragmented_general import find_SWR_time
