...
from gucompaper.ripple_detection import removeDataBeforeTrial1
from gucompaper.helpers import interpolate_to_new_time
from gucompaper.placefield import place_field,placefield_to_peak1dloc
from gucompaper.Analysis_SGU import DecodeResultsLinear
warnings.simplefilter("ignore", category=DeprecationWarning)
warnings.simplefilter("ignore", category=ResourceWarning)
warnings.filterwarnings('ignore')

from gucompaper.curation_manual import load_waveforms
from gucompaper.placefield import place_field, placefield_to_peak1dloc, cell_by_arm

from gucompaper.helpers import interval_union
from gucompaper.Analysis_SGU import TrialChoice,RippleTimes,EpochPos,ExtendedRippleTimes,RippleTimesWithDecode
from gucompaper.load import load_run_sessions
from gucompaper.singleUnit import (do_mountainSort,electrode_unit,
            RippleTime2FiringRate,findWaveForms,RippleTime2Index,get_nwb_units)

from gucompaper.load import load_theta_maze
from gucompaper.Analysis_SGU import get_linearization_map,segment_to_linear_range
from gucompaper.theta import return_firing
from gucompaper.Analysis_SGU import get_linearization_map
from scipy.stats import beta

from gucompaper.ripple_add_replay import plot_decode_sortedSpikes
